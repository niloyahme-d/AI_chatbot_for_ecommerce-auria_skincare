...
**[▶ Live Demo](https://niloyahme-d.github.io/AI_chatbot_for_ecommerce-auria_skincare/)**
...
This demo was built end-to-end — conversation design, UI, and front-end logic — as a self-contained example of the kind of chatbot built for freelance clients.
...
In production client work, this same interaction design is the blueprint that gets extended with a real LLM backend — typically via the **OpenAI API** or **Claude API** — for dynamic, open-ended conversations, plus integrations like **Zapier/Make** for connecting to a business's actual order/booking systems.
...
```bash
git clone https://github.com/niloyahme-d/AI_chatbot_for_ecommerce-auria_skincare.git
cd AI_chatbot_for_ecommerce-auria_skincare
...
**Niloy Ahmed** (Fiverr seller name: **Masum**)
